...
\begin{itemize}
  ...
  \item S simulacijami pokažite, kaj kaj se zgodi z velikostjo testa v primeru kršitve predpostavke o konstantni varianci. (Generiramo pod H0 kar pomeni, da je Beta1 = 0)
\end{itemize}
